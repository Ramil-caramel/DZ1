...
* Если ранее мы не нашли ошибку, то запустим функции [pre_obrabotka](pre_obrabotka.cpp) и **Error_Check** (эта функция проверяет есть ли в веденной строке ошибки)
